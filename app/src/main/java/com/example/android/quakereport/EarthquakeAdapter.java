...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
     ...
     * @param earthquakes A List of earthquakeItem objects to display in a list
     */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Get the version name from the current currentEarthquakeItem object and
        ...
        // Get the version number from the current currentEarthquakeItem object and
        ...
        dateTextView.setText(currentEarthquakeItem.getDate().toString());
